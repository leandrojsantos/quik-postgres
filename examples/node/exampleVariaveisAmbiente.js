...
esses arquivos serão selecionados conforme o ambiente
*/
 
//após pegar todas a variáveis sensíveis do código por exemplo conexão dos bancos, porta da api e salt/key  para criptografia
...
const Hapi = require('hapi')
//sao colocada primeiro para se algum precisar das variáveis
const env = process.env.NODE_ENV || "dev"
ok(env === "prod" || env === "dev", "environment inválida! Ou prod ou dev")
